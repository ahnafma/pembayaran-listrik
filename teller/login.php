...
<?php  
	...
	//jika session username teller tidak kosong, pindah ke halaman utama
	if (@$_SESSION['username_teller']!="") {
		$aksi->redirect("menu_utama.php?menu=home");
	}

	//jika tekan login maka menjalankan fungsi login dari library 
	if (isset($_POST['login'])) {
		$aksi->login("teller",$username,$password,"menu_utama.php?menu=home");
	}
...
<html>
<head>
	<title>LOGIN TELLER - Asatron</title>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							...
							<div style="margin-left: 110px; margin-top: -90px; font-size: 130%;">
								<strong>FORM LOGIN TELLER</strong>
							</div>
