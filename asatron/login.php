...
<html>
<head>
	<title>LOGIN MANAGER - ASATRON </title>
				...
				<div class="col-md-6">
					<div class="panel panel-primary">
							...
							<div class="col-md-12">
								<form method="post">
									<div class="form-group">
										...
										<input type="text" name="username" class="form-control" placeholder="Masukkan Username Anda..." value="manager" required maxlength="30" autocomplete="off">
									</div>
									<div class="form-group">
										<label>PASSWORD</label>
										<input type="password" name="password" class="form-control" placeholder="Masukkan Password Anda..." value="123" required maxlength="30" autocomplete="off">
									</div>
									<div class="form-group">
						...
						<div class="panel-footer">
							<center>
								<strong>&copy;Ahnaf Maulana Ardi 2024
							</center>
						</div>
						<!-- end footer -->
					</div>
