					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form method="post">
                                ...
                                <div class="form-group">
										<label>BATAS WAKTU BAYAR</label>
										<input type="text" name="batas_waktu" class="form-control" placeholder="Masukkan Batas Waktu Bayar" required value="<?php echo @$edit['batas_bayar']; ?>">
									</div>
									<div class="form-group">
